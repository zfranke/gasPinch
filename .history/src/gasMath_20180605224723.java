...
import java.util.*;
/**
 * @author Zachary "Steeldeal" Franke
 * Class: Gas Pincher Math Reference
 * Purpose: A way to help define the necessary math for the Gas Pincher App in a workable Java program
 * Use: For reference in building the Gas Pincher App.
 * 
 * NOTICE: This program is under the Dragon Horde Studios Information and NDA policy. Only authorized developers should have access to this file.
 *
 */
public class gasMath {
	...
	public static void main(String[] args) {
		...
		System.out.println();
		System.out.println();
		System.out.println("Info aqquired, processing information now.");
